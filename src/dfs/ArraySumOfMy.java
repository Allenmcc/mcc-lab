...
public class ArraySumOfMy {
    ...
    public static void dfs(int arr[], int start, int target, List<Integer> result) {
...
//        ArraySumOfMy solution = new ArraySumOfMy();
        int arr[] = {2, 6, 3, 7};
        list = combinationSum(arr, 9);
