...
//        List<Map<String, Object>> list = utils.ExcelUtil.createExcelRecord(projects, properties, ManagerReportDTO.class);

//        utils.ExcelUtil.createWorkBook(list, properties, columnNames).write(os);
