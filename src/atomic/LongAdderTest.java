...
public class LongAdderTest {
    ...
    /**
     * 从上结果图可以看出，在并发比较低的时候，LongAdder和AtomicLong的效果非常接近。
     * 但是当并发较高时，两者的差距会越来越大。上图中在线程数为1000，每个线程循环数为100000时，
     * LongAdder的效率是AtomicLong的6倍左右。
     */
...
//						atomicLong.incrementAndGet();
        ...
        System.out.println("result is:"+longAdder);
